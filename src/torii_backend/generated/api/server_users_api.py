...
class ServerUsersApi:
    ...
    def update_user_metadata(
        ...
        :param user_id: Identifier of the user to update. (required)
        :type user_id: UUID
        :param update_user_metadata_request: (required)
    ...
    @validate_call
    def update_user_metadata_with_http_info(
        self,
        user_id: Annotated[UUID, Field(description="Identifier of the user to update.")],
        update_user_metadata_request: UpdateUserMetadataRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def update_user_metadata_without_preload_content(
        self,
        user_id: Annotated[UUID, Field(description="Identifier of the user to update.")],
        update_user_metadata_request: UpdateUserMetadataRequest,
        _request_timeout: Union[
    ...
    def _update_user_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/server/v1/users/{userId}/metadata',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
